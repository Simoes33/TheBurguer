  ...
  return (
    <div className="landing-page">
      ...
      <div className="landing-brand">
        <Flame weight="fill" color="var(--ember)" size={26} />
      ...
      <p>Escolha uma opção pra continuar.</p>

      <div className="landing-options">

        {/* CLIENTE NO RESTAURANTE */}
        <Link to="/cardapio" className="landing-option">
          ...
          <p>
            Consulte o cardápio pela mesa e chame o garçom pra pedir.
          </p>
        </Link>

        {/* DELIVERY */}
        <Link to="/" className="landing-option">
          <div className="landing-option-icon">
            <Bicycle size={28} weight="fill" />
          </div>
