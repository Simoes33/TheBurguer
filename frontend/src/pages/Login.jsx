    ...
    <div className="login-page">
      ...
      <div className="login-image-panel" style={{
        backgroundImage: [
          ...
          "url('https://images.unsplash.com/photo-1676887451694-713019c9031f?q=80&w=1937&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
        ].join(', '),
      }}>
        <div>
